...
const Header = () => {
    ...
    return (
        <header className='flex w-full justify-between h-[3.7rem] bg-[#000000da] md:pl-14 md:pr-6 lg:pl-16 lg:pr-8 lg:p-3 text-white items-center  z-[100] py-[10px] px-6 shadow-[-1px_1px_7px_#000] fixed top-0 left-0 '>
            ...
            <nav className={` text-white md:border-0 shadow-[0px_160px_1000px_#12073ac5] md:shadow-none flex p-4 pb-10 md:p-0 w-screen md:max-w-[80vw] bg-[#000000da] items-center justify-between gap-3 md:gap-0 flex-col absolute 
