...
const Home = () => {
    ...
    return (
        <div className={`bg-[url('/src/assets/heroImg.png')] bg-cover bg-no-repeat bg-center overflow-x-hidden w-[100vw] h-[43rem] sm:h-[100vh]  
       relative`}>
            <div className="relative bg-black/60">
                <div className="w-[70rem] h-[43rem] sm:h-[100vh] overflow-hidden">
                    <div className="">
                        <svg className="BgAnimation__svg" viewBox="0 0 802 802" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.15">
            ...
            <div className='absolute top-0 flex flex-col-reverse items-center md:justify-around justify-center w-[99.5vw]  md:flex-row left-1 h-[43rem]'>
                <div className='flex flex-col gap-[2px]'>
                    <h1 className='text-[2.5rem] text-white font-semibold font-fre tracking-wider'>Hello - I am</h1>
                    <p className='font-fre text-[1.75rem] font-semibold text-white tracking-widest'>
                        <Typewriter
                            options={{
                    ...
                    <p className='text-[#f2f2f2] font-elite max-w-[26rem] mt-1 tracking-wide'>Highly motivated and detail-oriented
                        MERN Stack Web Developer with a strong
                        foundation in front-end and back-end
                        technologies.</p>
                    <Link target='_blank' to="https://drive.google.com/file/d/1r3DyCAMkcAeIE4uch_iv_6wC15jZC0Tw/view?usp=sharing" className='p-2 mt-4 transition-all duration-300 bg-black text-white font-[600] tracking-wide text-[1.05rem] px-4 border-[1.8px] border-[#1BFD9C] rounded-md w-fit shadow-[0px_0px_10px_#1BFD9C_inset] hover:shadow-[0px_0px_10px_#1BFD9C]'><FontAwesomeIcon className='mr-2' icon={faArrowRight} />Download CV!</Link>
                </div>
