       ...
       relative`}>
            ...
            <div className='absolute top-0 flex flex-col-reverse items-center md:justify-around justify-center w-[99.5vw]  md:flex-row left-1 h-[43rem]'>
                ...
                <div data-aos="fade-up" data-aos-duration="800" data-aos-easing="ease-in-sine" className='flex flex-col items-center justify-center gap-1'>
                    ...
                    <Link target='_blank' to="https://drive.google.com/file/d/1hkRyCSUoT9EcVAcPw4xnCVsURUhZf2qs/view?usp=sharing" className="flex items-center justify-center w-full h-20 cursor-pointer">
                        <div
                        ...
                        >
                            <span
                                className="absolute bottom-0 left-0 w-full h-1 transition-all duration-150 ease-in-out bg-[#00b153] group-hover:h-full"
                            ></span>
                            <span
